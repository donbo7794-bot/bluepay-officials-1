    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="p-4 flex-1">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-5 shadow-lg border border-blue-100">
            ...
            <Button 
              ...
              onClick={() => window.open('mailto: redpay313@gmail.com')}
           >
              Send Email
            </Button>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-5 shadow-lg border border-green-100">
            ...
            <Button 
              ...
              onClick={() => window.open('https://wa.me/2348054157696')}
            >
              Chat on WhatsApp
            </Button>
          </div>
        ...
        <div className="mt-6 text-center">
          ...
          <p className="text-blue-600 font-medium mt-1 text-sm">redpay313@gmail.com</p>
        </div>
      </div>
    </div>
  );
